...
from spotipy_ext import spotipy_ext
from spotipy_ext.auth import spotify_auth
...
class TestSpotipyExt(unittest.TestCase):
    ...
    def setUp(self):
        ...
        config = spotify_auth.get_user_config()
        config.update({'scope': 'user-library-read playlist-modify-private playlist-read-private'})
        self.spotifyExt = spotipy_ext.initialize_spotify_token(**config)
